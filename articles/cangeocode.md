...
That is a multi-hundred-megabyte download over a connection slow enough
that the package raises R’s timeout to 20 minutes, and it lands roughly
**5 GB on disk** for the 2026-06 release. Every later call reuses the
file and opens instantly.
