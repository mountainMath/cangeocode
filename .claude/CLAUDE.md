...
- **[`inst/notes/deepparse.md`](../inst/notes/deepparse.md)**
  ...
  98% to 0%, the guarded rule now shipped as `nar_strip_lead_prose()` that reversed the result,
  and why a fine-tune and a from-scratch model are both unwarranted on the evidence. It closes the open question at the
